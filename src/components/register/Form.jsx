    ...
    return (
        <div>
            <form className='flex flex-col mt-1 items-center'>
                ...
                <input required type="password" name="password" id="password" placeholder='Crie uma senha' className='bg-transparent border-[3px] border-[#E95401] w-80 h-12 rounded-2xl text-center text-white font-bold m-1'/>

                <input  required type="password" name="password" id="rePassword" placeholder='Repita sua senha' className='bg-transparent border-[3px] border-[#E95401] w-80 h-12 rounded-2xl text-center text-white font-bold m-1'/>
                ...
                <button type="submit" onClick={register} className='text-white font-bold bg-[#E95401] w-48 h-10 rounded-[10px] border-2 border-[#E95401] hover:bg-transparent hover:border-[#E95401] hover:border-2 transition duration-300 ease-in-out mt-2'>Entrar</button>
