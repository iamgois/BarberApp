...
export default function Navbar() {
  ...
  return (
    <div className='w-full max-w-sm flex items-center justify-between p-4'>
      <a onClick={back}>
        <button className='border-2 border-[#E95401] text-white font-bold rounded-[10px] w-20 h-8 transition ease-in-out duration-300 hover:bg-[#E95401]'><i class="fa-solid fa-arrow-left"></i></button>
      </a>
