    ...
    return (
        <div>
            <form className='flex flex-col items-center'>
                ...
                <a href="/service" onClick={manejo} className='transition duration-300 ease-in-out bg-transparent border-[3px] border-[#E95401] w-80 h-12 rounded-3xl text-center text-white font-bold flex items-center justify-center m-1 hover:bg-[#E95401]'>Manejo</a>
